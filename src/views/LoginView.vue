      ...
      <div class="form-pwd">
        <label>
          ...
          <template v-if="passType === 'password'">
            <input type="password" v-model="password" name="token" @input="updateDate" placeholder="Token">
          </template>
          <!--v-bind:class:动态切换class,取决于isShow的数据属性-->
